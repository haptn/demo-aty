...
export { default as BuyRentPage } from './pages/BuyRent/BuyRentPage'
export { default as SalePage } from './pages/Sale/SalePage'
...
export { default as StSalaryLevelsLayout } from './pages/Settings/aty-self/SalaryLevelsLayout'
